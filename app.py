...
from src.pipline.predict_pipeline import PredictPipeline
from src.pipline.predict_pipeline import CustomData
...
def predict_datapoint():
    if request.method == 'GET':
        ...
        logging.info("DataFrame: {}".format(pred_df))
        
        predict_pipeline=PredictPipeline()
        results=predict_pipeline.predict(pred_df)
        logging.info("Predicted Score: {}".format(results))
